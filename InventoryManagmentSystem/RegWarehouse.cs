...
{
    public partial class RegWarehouse : Sample
    {
        public RegWarehouse()
        {
            InitializeComponent();
        ...
        private void btnRegWr_Click(object sender, EventArgs e)
        {
            ...
            if (usrlbError.Visible || psLbError.Visible || RePsLbError.Visible || CtLbError.Visible)
            {
                ...
                string query = "Insert into tb_warehouse(wr_name,wr_password,wr_contact) values(@wr_name,@wr_password,@wr_contact)";
                ...
                if (a > 0)
                {
                    MessageBox.Show("WareHouse Member has been registered successfully..", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                MainClass.con.Close();
            }
